...
public class YmmoDbContext(DbContextOptions<YmmoDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Property>().HasData(
            ...
            new Property { Id = 7, Title = "Entrepôt Logistique 800m²", Description = "Entrepôt neuf en ZAC, hauteur 8m, 4 quais de chargement, bureau intégré 50m². Bail 3/6/9 ans.", Price = 890000m, Type = PropertyType.Commercial, Status = PropertyStatus.Available, AgencyId = 2, City = "Paris", Bedrooms = 0, Area = 800, ListedDate = new DateOnly(2026, 2, 14), CreatedAt = new DateTime(2026, 2, 14, 0, 0, 0, DateTimeKind.Utc) },
            new Property { Id = 8, Title = "Appartement T4 Prestige", Description = "T4 de standing 118m² au 6ème étage avec terrasse 30m². Vue panoramique, gardien, cave, 2 parkings.", Price = 695000m, Type = PropertyType.Residential, Status = PropertyStatus.Sold, AgencyId = 3, City = "Lyon", Bedrooms = 3, Area = 118, ListedDate = new DateOnly(2026, 1, 10), CreatedAt = new DateTime(2026, 1, 10, 0, 0, 0, DateTimeKind.Utc) },
            new Property { Id = 9, Title = "Terrain Constructible 650m²", Description = "Terrain plat viabilisé dans lotissement sécurisé. Permis de construire accordé pour villa R+1. Environnement verdoyant.", Price = 198000m, Type = PropertyType.Land, Status = PropertyStatus.Available, AgencyId = 4, City = "Marseille", Bedrooms = 0, Area = 650, ListedDate = new DateOnly(2026, 5, 5), CreatedAt = new DateTime(2026, 5, 5, 0, 0, 0, DateTimeKind.Utc) },
            new Property { Id = 10, Title = "Duplex Rooftop Exceptceptionnel", Description = "Duplex 160m² avec rooftop privatif 80m² face au Cours du Chapeau Rouge. Architecture contemporaine, matériaux nobles.", Price = 875000m, Type = PropertyType.Residential, Status = PropertyStatus.Available, AgencyId = 5, City = "Bordeaux", Bedrooms = 3, Area = 160, ListedDate = new DateOnly(2026, 4, 8), CreatedAt = new DateTime(2026, 4, 8, 0, 0, 0, DateTimeKind.Utc) }
        );
    }
}
